...
class SunrgbdDetectionVotesDataset(Dataset):
    def __init__(self, split_set='train', num_points=20000,
        ...
        if use_v1:
            ...
            self.bbox_2d_path = os.path.join(data_root, f'sunrgbd/sunrgbd_2d_bbox_50k_v1_{split_set}')
        else:
        ...
        self.scan_names = self.scan_names[:-3]
        ...
        # print(self.scan_names)
        # if split_set == 'train':
        #     self.scan_names = ['005051','005052','005053','005054','005055','005056','005057','005058']
        # else:
        #     # self.scan_names = ['000001','000002','000003','000004','000005','000006','000007','000001',]
        #     self.scan_names = ['000001','000002','000003']
        # self.scan_names = ['000001']
        # use_imvote
            ...
            for obj_img_data in obj_img_list:
                ...
                for u in range(u0, u0 + w):
                    for v in range(v0, v0 + h):
                        ...
                        full_img_votes[v, u, (
                                    1 + iidx * 4 + 3)] = i2d + 1  # add +1 here as we need a dummy feature for pixels outside all boxes
