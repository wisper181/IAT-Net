...
class Pointnet2Backbone(nn.Module):
    ...
    def __init__(self, input_feature_dim=0, width=1, pc_feature_dim=288, depth=2):
        super().__init__()
        self.depth = depth
        self.width = width
        ...
        self.fp2 = PointnetFPModule(mlp=[256 * width + 256 * width, 256 * width, self.pc_feature_dim])
